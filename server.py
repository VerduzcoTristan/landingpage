...
@media(orientation:landscape) and (max-height:600px) and (min-width:700px){.home-dashboard{grid-template-columns:minmax(0,2fr) minmax(15rem,.95fr)}.home-rail{grid-template-columns:1fr}}
